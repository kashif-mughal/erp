...
class Ccustomer extends CI_Controller {
    ...
    public function index() {
        ...
        $content = $this->lcustomer->customer_add_form($employee_list);
    ...
    public function insert_customer() {
        ...
        if ($result == TRUE) {
            ...
            $this->Customers->previous_balance_add($this->input->post('previous_balance'), $customer_id,$customer_name);
    ...
    public function customer_update_form($customer_id) {
        ...
        $content = $this->lcustomer->customer_edit_data($customer_id, $employee_list);
        $this->template->full_admin_html_view($content);
    }
