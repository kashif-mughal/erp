...
//        }
    ...
    public function sales_report_bill_wise() {

        $CI = & get_instance();
        $this->auth->check_admin_auth();
        $CI->load->library('linvoice');
        $CI->load->model('Invoices');
        $config["base_url"] = base_url('Admin_dashboard/sales_report_bill_wise/');
        ...
        $page = ($this->uri->segment(3)) ? $this->uri->segment(3) : 0;
        $links = $this->pagination->create_links();
        $content = $this->linvoice->invoice_list($links, $config["per_page"], $page, "report/sales_report_bill_wise", "Sales Report (Bill Wise)", 1);
        $this->template->full_admin_html_view($content);
    }
    public function date_to_date_invoice() {
        ...
        $config["base_url"] = base_url('Admin_dashboard/date_to_date_invoice/');
        ...
        $page = ($this->uri->segment(3)) ? $this->uri->segment(3) : 0;
        $links = $this->pagination->create_links();
        $content = $this->linvoice->invoice_list_date_to_date($from_date, $to_date, $links, $config["per_page"], $page, 1);
        $this->template->full_admin_html_view($content);

    }

    public function sales_report_bill_wise_search_by_user_name() {

        $customer_id = $this->input->get('customer_id');
        if(empty($customer_id))
            redirect("Admin_dashboard/sales_report_bill_wise");
        $CI = & get_instance();
        $this->auth->check_admin_auth();
        $CI->load->library('linvoice');
        $CI->load->model('Invoices');
        ...
        $page = ($this->uri->segment(3)) ? $this->uri->segment(3) : 0;
        $links = $this->pagination->create_links();
        $content = $this->linvoice->invoice_search($customer_id, $links, $config["per_page"], $page, "report/sales_report_bill_wise", "Sales Report (Bill Wise)", 1);
        $this->template->full_admin_html_view($content);

    }
    public function sales_report_bill_wise_search_by_invoice_id() {
        ...
        $content = $this->linvoice->invoice_list_invoice_no($invoice_no, 1);
        $this->template->full_admin_html_view($content);

    }

//>>>>>>>>>>Customer Wie <<<<<<<<<<<<
    public function monthly_report_search_by_invoice_id() {
    ...
    public function monthly_report_customer_wise() {
    ...
    public function date_to_date_customer_wise_report() {
        ...
        $config["base_url"] = base_url('Admin_dashboard/date_to_date_customer_wise_report/');
        $config["total_rows"] = $this->Invoices->invoice_list_date_to_date_count($from_date, $to_date);
        $config["per_page"] = 17;
        $config["uri_segment"] = 3;
        $config["num_links"] = 5;
        ...
        $page = ($this->uri->segment(3)) ? $this->uri->segment(3) : 0;
        $links = $this->pagination->create_links();
        $content = $this->linvoice->invoice_list_date_to_date_customer_wise($from_date, $to_date, $links, $config["per_page"], $page, 1);
        $this->template->full_admin_html_view($content);

    }
    public function sales_report_customer_wise_search_by_user_name() {
        $CI = & get_instance();
        $this->auth->check_admin_auth();
        $CI->load->library('linvoice');
        $CI->load->model('Invoices');
        ...
        $customer_id = $this->input->get('customer_id');
        $config["base_url"] = base_url('Admin_dashboard/sales_report_customer_wise_search_by_user_name/');
        $config["total_rows"] = $this->Invoices->invoice_search_count($customer_id);
        $config["per_page"] = 10;
        $config["uri_segment"] = 3;
        $config["num_links"] = 5;
        ...
        //$invoiceList = $type == 0 ? $CI->parser->parse('invoice/invoice', $data, true) : $CI->parser->parse('report/sales_report_bill_wise', $data, 
        $content = $this->linvoice->invoice_search_customer_wise($customer_id, $links, $config["per_page"], $page, 'report/sales_report_customer_wise','Sales Report (Customer Wise)');
        $this->template->full_admin_html_view($content);
...
public function monthly_sales_and_recovery() {

        $CI = & get_instance();
        $this->auth->check_admin_auth();
        $CI->load->library('linvoice');
        $CI->load->model('Invoices');
        $config["base_url"] = base_url('Admin_dashboard/monthly_sales_and_recovery/');
        //$config["total_rows"] = $this->Invoices->invoice_list_count();
        $config["per_page"] = 50;
        $config["uri_segment"] = 3;
        $config["num_links"] = 5;
        ...
        $page = ($this->uri->segment(3)) ? $this->uri->segment(3) : 0;
        $links = $this->pagination->create_links();
        $content = $this->linvoice->monthly_sales_and_recovery($links, $config["per_page"], $page, "report/monthly_sales_and_recovery", "Monthly Sales & Recovery");
        $this->template->full_admin_html_view($content);
    }
    public function date_to_date_monthly_sales_and_recovery() {
        ...
        $config["base_url"] = base_url('Admin_dashboard/date_to_date_monthly_sales_and_recovery/');
        $config["total_rows"] = $this->Invoices->invoice_list_date_to_date_count($from_date, $to_date);
        $config["per_page"] = 10;
        $config["uri_segment"] = 3;
        $config["num_links"] = 5;
        ...
        $page = ($this->uri->segment(3)) ? $this->uri->segment(3) : 0;
        $links = $this->pagination->create_links();
        $content = $this->linvoice->monthly_sales_and_recovery($links, $config["per_page"], $page, "report/monthly_sales_and_recovery", "Monthly Sales & Recovery", $from_date, $to_date);
        $this->template->full_admin_html_view($content);
