								...
								{return_list}
									<tr>
										...
										<td>
											...
											<a href="<?php echo base_url().'Cretrun_m/delete_retutn_invoice/{invoice_id}'; ?>" class="btn btn-danger btn-sm" data-toggle="tooltip" data-placement="left" title="<?php echo display('invoice') ?>"><i class="fa fa-trash" aria-hidden="true"></i></a>
												<?php echo form_close()?>
											</center>
										</td>
									</tr>
