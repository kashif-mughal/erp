...
<style>
    ...
    .limit-reached{
        box-shadow: 1px -1px 14px #b17404a6;
    }
</style>
            ...
            <div class="col-sm-12">
                ...
                <div class="panel panel-bd lobidrag">
                    ...
                    <div class="panel-body">
                        ...
                        <?php echo form_open_multipart('Cinvoice/insert_sale_order', array('class' => 'form-vertical', 'id' => 'insert_sale_order', 'name' => 'insert_sale_order')) ?>
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-6">
                                        <select class='form-control' name="customer_id" id="customer_id">
                                            <?php
                                            for($counter = 0; $counter < count($customer_list); $counter++)
                                            echo "<option value='".$customer_list[$counter]['customer_id']."'>".$customer_list[$counter]['customer_name']."</option>";
                                            ?>
                                        </select>
                        ...
                        <div class="table-responsive" id="sale-order-table" style="margin-top: 10px">
