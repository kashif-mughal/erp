...
<div class="content-wrapper">
	...
	<section class="content-header">
	    ...
	    <div class="header-title">
	        ...
	        <h1>Manage Sale Order</h1>

	        <small>Manage Sale Order</small>
	    ...
	    <div class="row">
            ...
            <div class="col-sm-12">
                ...
                <div class="column">
                  ...
                  <a href="<?php echo base_url('Cinvoice/manage_sale_order')?>" class="btn btn-primary m-b-5 m-r-2"><i class="ti-align-justify"> </i>  Manage Sale Order</a>
			...
			<div class="col-sm-7">
		        ...
		        <div class="panel panel-default">
		            ...
		            <div class="panel-body"> 
		                ...
		                <?php echo form_open('Cinvoice/manage_sale_order',array('class' => 'form-inline','method' => 'get'))?>

		                <?php date_default_timezone_set("Asia/karachi"); $today = date('Y-m-d'); ?>

		                    <div class="form-group">

		                        <label class="" for="from_date"><?php echo display('start_date') ?></label>

		                        <input type="text" name="from_date" class="form-control datepicker" id="from_date" value="<?php echo $startdate?>" placeholder="<?php echo display('start_date') ?>" >
		                    ...
		                    <div class="form-group">
		                        ...
		                        <input type="text" name="to_date" class="form-control datepicker" id="to_date" placeholder="<?php echo display('end_date') ?>" value="<?php echo $enddate?>">
		   ...
		   <div class="col-sm-5">
		        ...
		        <div class="panel panel-default">
		            ...
		            <div class="panel-body"> 
						...
						<form action="<?php echo base_url('Cinvoice/manage_sale_order')?>" class="form-inline" method="post" accept-charset="utf-8">
								...
								?>
									...
									<tr>
										...
										<td>
											...
											<a href="<?php echo base_url().'Ccustomer/customerledger/'.$invoice['customer_id']; ?>"><?=$invoice['customer_name']?></a>				
										...
										<td>
											...
											<center>
												...
												<?php echo form_open()?>
													...
													<a href="<?php echo base_url().'Cinvoice/sale_order_detail/'.$invoice_id; ?>" class="btn btn-info btn-sm" data-toggle="tooltip" data-placement="left" title="Sale Order Detail"><i class="fa fa-window-restore" aria-hidden="true"></i></a>
	...
	{	
		...
		$.ajax
		   ...
		   ({
				...
				url: '<?php echo base_url('Cinvoice/sale_order_delete')?>',
