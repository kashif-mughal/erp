...
class Suppliers extends CI_Model {
    ...
    public function supplier_list_balance($per_page = null, $page = null) {
    ...
    public function previous_balance_add($balance, $supplier_id,$supplier_name) {
        ...
        $data = array(
            ...
            'deposit_no' => NULL,
            'amount' => $balance,
            'description' => "Previous adjustment of $supplier_name with software ",
            'payment_type' => "NA",
            'cheque_no' => "NA",
            'date' => date("Y-m-d"),
            'status' => 1
